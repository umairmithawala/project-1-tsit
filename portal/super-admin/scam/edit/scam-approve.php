...
$timestamp = time();
$sql = "UPDATE `scams` SET `superadmin_approval` = 1, `is_active` = 1,`superadmin_rejected` = 0,`superadmin_approval_timestamp` = $timestamp WHERE `id` = $get_id";
