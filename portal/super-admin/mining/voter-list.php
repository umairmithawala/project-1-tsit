                                    ...
                                    <table id="example" class="display" style="min-width: 845px;">
                                       ...
                                       <tbody>
                                          <?php
                                             ...
                                             if ($rows1 > 0 && $runquery1 == TRUE) {
                                                 while ($data1 = mysqli_fetch_assoc($runquery1)) {
                                                     ...
                                                     $query2    = "SELECT `id`,`user_role`,`name`,`user_img` FROM `users` WHERE `id` = $voter_id";
                                          ...
                                          <tr>
                                             ...
                                             <td class="text-center">
                                                <a href="../mining/view-pos.php?uid=<?php echo $voter_user_id; ?>&sid=<?php echo $scam_id; ?>">
