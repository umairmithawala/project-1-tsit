...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE HERE -->
        <title>POS Submitted - Tesla INU Web Portal</title>
        <!-- FAVICONS ICON -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center ai-icon text-primary">
                                    ...
                                    <h4 class="my-4">Thank your for uploading POS</h4>
                                    <a href="../scam/view-scam.php?id=<?php echo $scam_id; ?>" class="btn my-2 btn-primary btn-lg px-4"><i class="fa fa-usd"></i> Add Another</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
