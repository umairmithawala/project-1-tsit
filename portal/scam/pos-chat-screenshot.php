...
if ($_FILES['pos_files']['name'] != '') {
    ...
    //delete old data if already existed

    $query10 = "DELETE FROM `pos` WHERE `user_id` = $user_id AND `scam_id` = $scam_id AND `proof_of` = 'scammer chat screen shot'";
    if ($con->query($query10) === true) {}

    $query = "INSERT INTO `pos`(`id`, `user_id`, `scam_id`, `proof_of`, 
    `file_name`, `timestamp`) VALUES (NULL,$user_id,$scam_id,'scammer chat screen shot','$pos_files',$timestamp);";
...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE HERE -->
        <title>POS Scammer Chat Screen Shot- Tesla INU</title>
        <!-- FAVICONS ICON -->
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
                        <h2 class="mb-3 me-auto">Scammer Chat Screen ShotPOS</h2>
                        ...
                        <div class="col-xl-12 col-lg-6">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Upload Scammer Chat Screen ShotProof</h4>
