...
<?php
   if(isset($_SESSION['user_session_var'])){
    ...
    if ($user_data['kyc_approved'] == 1) {
     ...
     }else if ($user_data['kyc_approved'] == 0) {
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center ai-icon text-primary">
                                    ...
                                    <h4 class="my-4">Thank your for submitting KYC.</h4>
                                    <a href="../dashboard/index.php" class="btn my-2 btn-primary btn-lg px-4"><i class="fa fa-usd"></i> Back To Home</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3"></div>
