...
if (isset($_POST['submit'])) {
    ...
    $category_first = $_POST['category_first'];
    $category_first = htmlspecialchars($category_first, ENT_QUOTES, "UTF-8");
    $category_second = $_POST['category_second'];
    $category_second = htmlspecialchars($category_second, ENT_QUOTES, "UTF-8");
    //check category second null or not
    if ($category_second == "") {
        $category_second = "NULL";
    }
    $category_third = $_POST['category_third'];
    $category_third = htmlspecialchars($category_third, ENT_QUOTES, "UTF-8");
...
?>
    ...
    if ($count_rows == 0) {
        ...
        //check category second and category third is empty or not
        

        $query1 = "INSERT INTO `blog`(`id`,`blog_title`,`thumbnail_img`,`blog_body`, `publish_date`, `keywords`, `unique_link`, `category_first_id`,`category_second_id`,`category_third_id`,`likes`,`view`,`added_by`,`description`,`timestamp`) VALUES (NULL,'$title','$thumbnail_img_name','$blog_content','$publish_date_timestamp','$blog_keyword','$unique_id ',$category_first,$category_second,$category_third,'$total_likes','$total_views',$added_by_user_id,'$description','$timestamp')";
                            ...
                            <div class="box overflow-h">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="box-body pt-50 pb-50">
                                        ...
                                        <div class="row pb-50">
                                            <div class="col-md-2">
                                                <label class="col-form-label">Unique Link</label>
                                            </div>
                                            <div class="col-md-10">
                                        ...
                                        <div class="row pb-50">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <small>Please enter SEO Description</small>
                                            </div>
                                        </div>
                                        <div class="row pb-50">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="category_first" id="" required>
                                                            <?php
                                        ...
                                        <div class="row pb-50">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="category_second" id="">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="category_third" id="">
                                                            <option value="0">Choose One</option>
                                                            <?php
                                                            $query2 = "SELECT * FROM `category_list`";
                                                            $run_query2 = mysqli_query($con, $query2);
                                        ...
                                        <div class="row pb-50">
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="col-form-label">Total Likes</label>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="total_likes" placeholder="Enter total likes" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <label class="col-form-label">Total Views</label>
                                                    </div>
                                                    <div class="col-md-8">
                                                        <input class="form-control" type="text" name="total_views" placeholder="Enter total views" required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row pb-50">
                                            <div class="col-md-2">
                                                <label class="col-form-label">Add Content</label>
                                            </div>
                                            <div class="col-md-10">
                                        ...
                                        <div class="row pb-50">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input name="blog-keyword" type="text" value="" data-role="tagsinput" placeholder="add keywords" required>
                                                    </div>
                                                </div>
                                            </div>
