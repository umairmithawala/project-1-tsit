...
<head>
   ...
   <!-- PAGE TITLE HERE -->
   <title>KYC Rejected User Management - Tesla INU</title>
   <!-- FAVICONS ICON -->
      ...
      <div class="content-body">
         ...
         <div class="container-fluid">
            <div class="mb-sm-4 d-flex flex-wrap align-items-center text-head">
               <h2 class="mb-3 me-auto">KYC Rejected Users List</h2>
            </div>
            <div class="row">
                     ...
                     <div class="card-body">
                        ...
                        <div class="table-responsive">
                           <table id="example" class="display" style="min-width: 845px;">
                              ...
                              <tbody>
                                 <?php
                                 $query1 = "SELECT * FROM `users` WHERE `kyc_approved` = 0 ORDER BY `id` DESC";
