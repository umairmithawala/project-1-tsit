...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE HERE -->
        <title>Vote Limit Exceed - Tesla INU</title>
        <!-- FAVICONS ICON -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center ai-icon text-primary">
                                    <div class="row">
                                        <div class="col-12">
                                            <i id="thumb_up_color" class="fas fa-exclamation-triangle" style="font-size: 150px; color: #f72b50 !important; cursor: pointer;"></i>
                                    ...
                                    <h4 class="my-4">Sorry, we reached maximum vote count. Your vote not submitted.</h4>

                                    <a  href="../mining/scam-mining.php" class="btn my-2 btn-primary btn-lg px-4"><i class="fa fa-usd"></i> Mine Scams</a>
