...
<body class="crumina-grid">
   ...
   ?>
    ...
    <script src="assets/modules/forms/src/js/jquery.validate.min.js"></script>
    <script src="assets/modules/forms/src/js/sweetalert2.all.js"></script>
    <script src="assets/modules/forms/src/js/scripts.js"></script>
