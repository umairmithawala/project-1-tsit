...
if (isset($_POST['update'])) {
   ...
   $update_category_id_first = $_POST['update-category-first'];
   $update_category_id_first = htmlspecialchars($update_category_id_first, ENT_QUOTES, "UTF-8");
   $update_category_id_second = $_POST['update-category-second'];
   $update_category_id_second = htmlspecialchars($update_category_id_second, ENT_QUOTES, "UTF-8");
   //check category second null or not
//    if ($update_category_id_second == "") {
//       $update_category_id_second = 0;
//   }
   $update_category_id_third = $_POST['update-category-third'];
   $update_category_id_third = htmlspecialchars($update_category_id_third, ENT_QUOTES, "UTF-8");
   //check category third null or not
   // if ($update_category_id_third == "") {
   //    $update_category_id_third = "NULL";
   // }
   ...
   // echo $update_publish_date_timestamp;

   // echo $update_publish_date;
   ...
   if ($unique_id_validate == 1) {
      ...
      if ($_FILES['edit_blog_thumb_image_file_input']['name'] != '') {
         ...
         if (in_array($thumbnail_img_extension, $valid_extensions)) { // check if upload file is a valid image file.
            ...
            move_uploaded_file($_FILES['edit_blog_thumb_image_file_input']['tmp_name'], $path_one);
      ...
      $query3 = "UPDATE `blog` SET `blog_title`='$update_blog_title'
               ...
               ,`keywords`='$update_blog_keyword',`unique_link`='$unique_id',`category_first_id`='$update_category_id_first',`category_second_id`='$update_category_id_second',`category_third_id`='$update_category_id_third',
                        ...
                        <form method="POST" enctype="multipart/form-data">
                           ...
                           <div class="box-body pt-50 pb-50">
                              ...
                              <div class="row">
                                 <div class="col">
                                    <div class="form-group row pt-30">
                                       <label class="col-form-label col-md-4">blog Category First</label>
                                       <div class="col-md-8">
                                          <select class="form-control" name="update-category-first" value="<?php echo $category_id; ?>">
                                          <option value="">Choose One</option>
                                             ...
                                             ?>
                                                   <option value="<?php echo $data2['id']; ?>" <?php if ($category_first_id == $data2['id']) {
                                                                                                   echo 'selected';
                                 ...
                                 <div class="col">
                                    <div class="form-group row pt-30">
                                       <label class="col-form-label col-md-4">blog Category Second</label>
                                       <div class="col-md-8">
                                          <select class="form-control" name="update-category-second" value="<?php echo $category_id; ?>">
                                          <option value="0">Choose One</option>
                                             ...
                                             if ($run_query2) {
                                                while ($data2 = mysqli_fetch_assoc($run_query2)) {
                                             ?>
                                                   <option value="<?php echo $data2['id']; ?>" <?php if ($category_second_id == $data2['id']) {
                                                                                                   echo 'selected';
                                                                                                } ?>> <?php echo $data2['name']; ?> </option>
                                             <?php
                                                }
                                 ...
                                 <div class="col">
                                    <div class="form-group row pt-30">
                                       <label class="col-form-label col-md-4">blog Category Third</label>
                                       <div class="col-md-8">
                                          <select class="form-control" name="update-category-third" value="<?php echo $category_id; ?>">
                                          <option value="0">Choose One</option>
                                             <?php
                                             $query2 = "SELECT * FROM `category_list`";
                                             $run_query2 = mysqli_query($con, $query2);
                                             if ($run_query2) {
                                                while ($data2 = mysqli_fetch_assoc($run_query2)) {
                                             ?>
                                                   <option value="<?php echo $data2['id']; ?>" <?php if ($category_third_id == $data2['id']) {
                                                                                                   echo 'selected';
                                                                                                } ?>> <?php echo $data2['name']; ?> </option>
                                             <?php
                                                }
