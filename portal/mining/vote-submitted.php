...
<html lang="en">
    <head>
        ...
        <!-- PAGE TITLE HERE -->
        <title>Vote Submitted - Tesla INU</title>
        <!-- FAVICONS ICON -->
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body text-center ai-icon text-primary">
                                    <div class="row">
                                        <div class="col-12">
                                            <i onclick="voteIconChange(1);" id="thumb_up_color" class="far fa-check-circle" style="font-size: 150px; color: #68e365 !important; cursor: pointer;"></i>
                                    ...
                                    <h4 class="my-4">Your vote have been submitted</h4>
